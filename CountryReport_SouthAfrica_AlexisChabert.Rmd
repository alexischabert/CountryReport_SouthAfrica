...
infectiousdeseases <- ggplot(NBM_5) +
 ...
 geom_line(size = 1.2) +
 scale_color_hue() +
 labs(x = "Year", y = "Deaths from infectious diseases (deaths/100,000 people)", title = "Deaths from infectious diseases (deaths/100,000 people)", caption = "SKEMA Global Lab in AI") +
 theme_minimal()
...
childmortality <- ggplot(NBM_3) +
 ...
 geom_line(size = 1.2) +
 scale_color_hue() +
 labs(x = "Year", y = "Child mortality", title = "Child mortality", caption = "SKEMA Global Lab in AI") +
 theme_minimal()
...
lifeexpectancy$series_code <- gsub("SP_DYN_LE00.A.Y0._T._T.014.M", "Eastern Africa", lifeexpectancy$series_code)
lifeexpectancy$series_code <- gsub("SP_DYN_LE00.A.Y0._T._T.202.M", "Sub-Saharan Africa", lifeexpectancy$series_code)
lifeexpectancy
```
...
"1975", "1980", "1985", "1990", "1995", "2000", "2005", "2010", "2015", "2020")) %>%
 ggplot() +
 aes(x = series_code, y = value) +
 geom_boxplot(fill = "#4292c6") +
 labs(x = "Area/Country", y = "Age", title = "Life expectancy at birth (years)", caption = "SKEMA Global Lab in AI - UNDATA") +
 theme_gray()
```
...
lifeexpectancy %>%
 filter(original_period %in% "2020") %>%
 ggplot() +
 aes(x = series_code, fill = series_code, weight = value) +
 geom_bar() +
 scale_fill_hue() +
 theme_minimal()
```
